...
def plot_runs(left, right):
    ...
    #for files in os.walk("out/"):
    #    for f in files:
    #        os.chmod(f, 0o777)
    #os.makedirs("out/", 0o777)
    subprocess.call(['chmod', '-R', '777', 'out/'])
    ...
    if (False):
        ...
        trace_0_avg = trace_0
        trace_1_avg = trace_1
    print("trace_0_avg: ", trace_0_avg, "trace_1_avg", trace_1_avg)
    # Prepare figure
...
def do_runs(iteration_number_1, directory_1, iteration_number_2, directory_2):
    ...
    while (monitor_err != 0 and trials < 3):
        ...
        try:
            monitor_err = monitor_popen.wait(timeout=60000)
        except:
...
if __name__ == '__main__':
    ...
    cleansing_mechanism = 2      # 1 for clflush the address space; 2 for L1 and L2 flushing
    ...
    try:
        ...
        pass
    try:
        os.makedirs('data/eddsa-0', 0o777)
    except:
        pass
    try:
        os.makedirs('data/eddsa-1', 0o777)
    except:
        pass
    try:
        os.makedirs('data/rsa-0', 0o777)
    except:
        pass
    try:
        os.makedirs('data/rsa-1', 0o777)
    except:
        pass
    try:
        os.makedirs('plot', 0o777)
    except:
        pass
